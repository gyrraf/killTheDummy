...
public class Fight extends Object {
	...
	public static void main(String[] args) {
		...
		in.close(); //The very end. No command should be after this.
	} //End of main method
	...
	private static void playerAttack() {
		...
		in.nextLine();
		System.out.println("\n");
	} //End of method 'attack(): void'
	
	/**
	 * asks which ability should be used and uses it if it isn't on cooldown.
	...
	private static void createEnemy() {
		...
		try {
			...
			System.out.println(
					"something went wrong with your input. Your enemy will get " 
					+ Stats.getPlayerStartHP()
					+ " hp too."
					);
	...
	private static void instructions() {
		...
		in.nextLine();
		System.out.println(
				"Each turn you can choose between four abilities,"
